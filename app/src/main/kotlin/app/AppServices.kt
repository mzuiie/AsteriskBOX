...
internal data class AppServices(
    ...
    val backupFilePicker: suspend () -> Uri?,
    val backupFileCreator: suspend (String) -> Uri?,
    ...
    val directTrafficCounter: DirectTrafficCounter,
    val proxyServiceUseCase: ProxyServiceUseCase,
    val freeFlowUseCase: FreeFlowUseCase,
