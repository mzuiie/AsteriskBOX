...
internal val MIGRATION_3_4 = object : Migration(3, 4) {
    override fun migrate(db: SupportSQLiteDatabase) {
        db.execSQL("ALTER TABLE outbounds ADD COLUMN meta TEXT")
        db.execSQL("ALTER TABLE outbound_groups ADD COLUMN ownerKey TEXT")
        db.execSQL(
            "CREATE TABLE IF NOT EXISTS `free_flow_profile` " +
