...
internal class RootModeEngine(
    ...
    private suspend fun buildLocalProxyOptions(request: ProxyEngineStartRequest) =
    ...
    companion object {
        ...
        suspend fun prepareConfig(context: Context, runMode: Int, request: ProxyEngineStartRequest): RootModeStartConfig {
