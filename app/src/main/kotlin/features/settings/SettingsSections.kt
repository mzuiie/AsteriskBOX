...
internal fun SettingsCoreSection(
    ...
    SettingsSectionCard {
        SettingsCoreItems.forEach { item ->
            when (item) {
                SettingsCoreItem.Mianliu -> ArrowPreference(
                    title = stringResource(R.string.settings_mianliu),
                    icon = Icons.Rounded.Bolt,
                    summary = stringResource(R.string.settings_mianliu_summary),
                    onClick = onOpenMianliu,
                )
...
internal fun SettingsProxyModeSections(
    ...
    enableHotspotAutoShare: Boolean,
    ...
    onEnableHotspotAutoShareChange: (Boolean) -> Unit,
    onOpenExternalInterfaces: () -> Unit,
    onOpenServiceControl: () -> Unit,
    onOpenRootDiagnostics: () -> Unit,
    ...
    AnimatedVisibility(
        ...
        Column {
            ...
            exit = AsteriskMotion.contentExit(),
                ...
                ArrowPreference(
                    title = stringResource(R.string.settings_root_diagnostics),
                    icon = Icons.Rounded.TravelExplore,
                    summary = stringResource(R.string.settings_root_diagnostics_summary),
                    onClick = onOpenRootDiagnostics,
                )
                AnimatedVisibility(
            ...
            exit = AsteriskMotion.contentExit(),
                ...
                SwitchPreference(
                    title = stringResource(R.string.settings_hotspot_auto_share),
                    icon = Icons.Rounded.Lan,
                    summary = stringResource(R.string.settings_hotspot_auto_share_summary),
                    checked = enableHotspotAutoShare,
                    onCheckedChange = onEnableHotspotAutoShareChange,
                )
                AnimatedVisibility(
